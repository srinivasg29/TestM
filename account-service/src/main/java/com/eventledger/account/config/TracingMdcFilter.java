 ...
 * Spring Boot's own tracing observation filter (default ordering), so the current span - continued
 * from the Gateway's "traceparent" header - is already active by the time it executes.
 */
@Component
